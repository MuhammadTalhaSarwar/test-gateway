import type { IAny, IBasicDelay, IComplexDelay, IExposedWrapper, ILimit, ILimitStack, IMixedDelays, INormalizedDelays, IReject, IResolve, ITarget, IWrapper, Optional, TimeoutID } from './interface.js';
